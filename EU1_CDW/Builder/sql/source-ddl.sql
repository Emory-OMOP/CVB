...
--
-- temp.mapping declares the canonical 21 pipeline columns ONLY, in canonical
-- order. execute-pipeline.sh trims mapping.csv to PIPELINE_COLS=21 before
-- \copy, so the Emory extension columns (22-24: valid_start_date,
-- valid_end_date, source_frequency) never reach this table. They ride in the
-- sheet and are published to the release artifact by
-- scripts/package-mapping-release.py — see EU1_CDW/README.md.
...
-- Raw mapping table — columns match mapping.csv columns 1-21
