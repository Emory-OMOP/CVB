...
# Columns 1-21 are pipeline columns; 22+ are workspace/extension columns
# (valid_start_date, valid_end_date, source_frequency) that are stripped
# before loading. They still ship to the release artifact — see
# scripts/package-mapping-release.py.
# ------------------------------------------------------------------
